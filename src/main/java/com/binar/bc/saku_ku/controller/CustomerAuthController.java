...
public class CustomerAuthController {
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Logout berhasil", content = @Content(
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Registrasi berhasil", content = @Content(
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "422", description = "Email/No HP/NIK sudah terdaftar", content = @Content(
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Login berhasil", content = @Content(
                    mediaType = "application/json",
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Identifier/password kosong", content = @Content(
                    mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.BAD_REQUEST))),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Salah kredensial, atau akun belum ACTIVE (belum verifikasi OTP)", content = @Content(
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "LOGIN_SUCCESS atau NEEDS_REGISTRATION", content = @Content(
                    mediaType = "application/json",
                    examples = {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Firebase ID token tidak valid/kedaluwarsa", content = @Content(
                    mediaType = "application/json",
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Akun terverifikasi", content = @Content(
                    mediaType = "application/json",
                    examples = @ExampleObject(value = "{\"statusCode\":200,\"message\":\"Akun berhasil diverifikasi\",\"data\":" + CUSTOMER_RESPONSE_EXAMPLE_ACTIVE + "}"))),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Kode OTP salah/sudah kedaluwarsa", content = @Content(
                    mediaType = "application/json",
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Kode baru terkirim", content = @Content(
                    mediaType = "application/json", examples = @ExampleObject(value = "{\"statusCode\":200,\"message\":\"Kode OTP baru sudah dikirim\",\"data\":null}"))),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Email tidak ditemukan / akun sudah terverifikasi", content = @Content(
                    mediaType = "application/json",
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Kode OTP terkirim ke email", content = @Content(
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Email tidak terdaftar", content = @Content(
                    mediaType = "application/json",
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Kode valid", content = @Content(
                    mediaType = "application/json", examples = @ExampleObject(value = "{\"statusCode\":200,\"message\":\"Kode OTP valid\",\"data\":null}"))),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Kode salah/kedaluwarsa", content = @Content(
                    mediaType = "application/json",
                    examples = @ExampleObject(value = "{\"timestamp\":\"2026-09-21T10:15:30Z\",\"status\":422,\"error\":\"Unprocessable Entity\",\"message\":\"Kode OTP salah atau sudah kadaluarsa\"}")))
    })
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Password berhasil direset", content = @Content(
                    mediaType = "application/json", examples = @ExampleObject(value = "{\"statusCode\":200,\"message\":\"Password berhasil direset\",\"data\":null}"))),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Kode OTP salah/kedaluwarsa/sudah dipakai", content = @Content(
                    mediaType = "application/json",
                    examples = @ExampleObject(value = "{\"timestamp\":\"2026-09-21T10:15:30Z\",\"status\":422,\"error\":\"Unprocessable Entity\",\"message\":\"Kode OTP salah atau sudah kadaluarsa\"}")))
    })
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Password berhasil diubah", content = @Content(
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "OK", content = @Content(
                    mediaType = "application/json",
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Profil berhasil diperbarui", content = @Content(
                    mediaType = "application/json",
                    examples = @ExampleObject(value = "{\"statusCode\":200,\"message\":\"Profil berhasil diperbarui\",\"data\":" + CUSTOMER_RESPONSE_EXAMPLE_ACTIVE + "}"))),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "NIK sudah diisi sebelumnya / email atau No HP sudah dipakai akun lain", content = @Content(
                    mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.UNPROCESSABLE_EMAIL_TAKEN))),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Belum login", content = @Content(
                    mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.UNAUTHORIZED_TOKEN)))
    })
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Token tersimpan", content = @Content(
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "fcmToken kosong", content = @Content(
                    mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.BAD_REQUEST)))
    })
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Akun berhasil dihapus", content = @Content(
                    mediaType = "application/json", examples = @ExampleObject(value = "{\"statusCode\":200,\"message\":\"Akun berhasil dihapus\",\"data\":null}"))),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Password salah, atau akun sudah dihapus sebelumnya", content = @Content(
                    mediaType = "application/json", examples = @ExampleObject(value = SwaggerExamples.UNAUTHORIZED_LOGIN)))
    })
